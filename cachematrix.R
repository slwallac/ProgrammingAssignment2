##Assignmnet: Caching the Inverse of a Matrix
...
cachesolve <- function(x) {
  ...
  if(!is.null(m)) { 
    #Function executed based on the principle that the cache was not empty because in that case the inverse is in the cache.
